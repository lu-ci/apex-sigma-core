...
async def cry(cmd, pld):
    ...
    ender = 'cries' if target.id == pld.msg.author.id else f'cries because of {target.display_name}'
    response = discord.Embed(color=0x5dadec, title=f'😢 {auth.display_name} {ender}.')
