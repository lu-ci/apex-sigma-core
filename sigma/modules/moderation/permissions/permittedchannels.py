...
async def permittedchannels(cmd: SigmaCommand, message: discord.Message, args: list):
        ...
        if mode_vars:
            ...
            if node_name in check_group:
                ...
                if overridden_channels:
                    ...
                    response = discord.Embed(color=0x696969, title=f'🔍 No overridden channels found for {node_name}.')
            else:
