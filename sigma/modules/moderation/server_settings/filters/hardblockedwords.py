...
async def hardblockedwords(_cmd, pld):
    """
    ...
    if not blocked_words:
        response = GenericResponse('There are no hard-blocked words.').info()
    else:
        ...
        response = GenericResponse(f'Words hard-blocked on {pld.msg.guild.name}').info()
