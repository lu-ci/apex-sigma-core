...
`>>hangman` | Classic hangman. Guess the word in less than six tries. You have 30 seconds to guess each letter. It's possible for the word to include a hyphen. The Kud reward is equal to the number of letters in the word. | `>>hangman`
