...
`>>decrypt` | Decrypts any message that was encrypted using the Sigma Heart Key. | `>>decrypt gAAAAABaAvRv2SqSGiJ74sNOAmKtBtwPmzO1qNtmroe3d6-`
...
`>>encrypt` | Encrypts the message of your choice using the Sigma Heart Key. The message can be decrypted using the decrypt command. | `>>encrypt I will always be here to talk to you for as long as you want.`
