...
`>>autopunishlevels` `>>automodlevels` | Sets the desired punishment for a certain number of warnings. Provide no arguments to display the current levels. This command requires the Manage Server permission. | `>>autopunishlevels 1:textmute 12:0:0`
